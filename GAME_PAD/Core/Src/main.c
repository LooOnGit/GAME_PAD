...
volatile uint8_t ButtonPoten3 = 0;
volatile uint8_t ButtonPoten4 = 0;
volatile uint8_t EnAPoten1 = 0;
volatile uint8_t EnBPoten1 = 0;
volatile uint8_t EnAPoten2 = 0;
volatile uint8_t EnBPoten2 = 0;
volatile uint8_t EnAPoten3 = 0;
volatile uint8_t EnBPoten3 = 0;
volatile uint8_t EnAPoten4 = 0;
volatile uint8_t EnBPoten4 = 0;
...
//	keyboardhid.Keycode1 = pulse2*50;
	...
	if(pulsePre3 > pulseOld3){
		pulseOld3 = pulsePre3;
		keyboardhid.Keycode1 = keyboardhid.Keycode1 | 0x02;
	}

	if(pulsePre3 < pulseOld3){
		pulseOld3 = pulsePre3;
		keyboardhid.Keycode1 = keyboardhid.Keycode1 | 0x04;
	}
