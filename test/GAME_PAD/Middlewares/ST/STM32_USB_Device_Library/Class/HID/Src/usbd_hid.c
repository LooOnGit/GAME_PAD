...
//		 0x81, 0x02, // INPUT (Data,Var,Abs)
		 ...
		 0x29, 0x14,       // USAGE_MAXIMUM (Button 14)
		 0x15, 0x00,       // LOGICAL_MINIMUM (0)
		 0x25, 0x01,       // LOGICAL_MAXIMUM (1)
		 0x75, 0x01,       // REPORT_SIZE (1)
		 0x95, 0x14,       // REPORT_COUNT (14)
		 0x81, 0x02,       // INPUT (Data,Var,Abs)

		 // Padding 2 bit để làm tròn byte
		 0x75, 0x01,       // REPORT_SIZE (1)
		 0x95, 0x04,       // REPORT_COUNT (4) ; Padding để làm tròn thành 24 bit (3 byte)
