...
volatile bool enBPotenFlag;
volatile bool enAPotenFlag;
volatile uint32_t lastATime = 0;
volatile uint32_t lastBTime = 0;
#define DEBOUNCE_TIME 15  // 50ms for debounce
